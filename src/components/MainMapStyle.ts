...
export const styleSetSubarea_Adress = {
  outline: "none",
  width: "318px",
  height: "14vh",
  marginTop: "26vh",
...
//=== VertexForma =====================================================
export const styleFormVert = (PLANER: number) => {
  const styleFormVert00 = {
    outline: "none",
    position: "relative",
  ...
  return styleFormVert00;
};

export const styleFormName = {
  fontSize: 17,
  marginTop: 0.5,
  marginBottom: 2,
  textAlign: "center",
...
//=== CreatePK ========================================================
export const MakeStyleFormPK00 = (wdth: number, PLANER: number) => {
  const styleFormPK00 = {
    outline: "none",
    position: "relative",
    //marginTop: '-94.0vh',
...
export const StylSpisPK02 = (delMode: boolean, illum: boolean) => {
  const styleSpisPK02 = {
...
export const StylSpisPK022 = (delMode: boolean, illum: boolean) => {
  const styleSpisPK02 = {
