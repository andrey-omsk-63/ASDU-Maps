...
const MapRouteBind = (props: {
  ...
  //========================================================
  let dat = massroute.vertexes[0].lin;
  let massKey = [];
  let massDat = [];
  ...
  return (
    ...
    >
      <>
        ...
        <Grid
          container
          sx={{ border: 0, marginTop: "33vh", height: 24, width: "100%" }}
        >
          <Grid item xs={0.25} sx={{ border: 0 }}></Grid>
          <Grid item xs={3.5} sx={{ border: 0, textAlign: "right" }}>
          ...
          <Grid item xs={3.5} sx={{ border: 1, textAlign: "right" }}>
            <b>№ входящего направления:</b>
          </Grid>
          <Grid item xs={0.5} sx={{ border: 1 }}></Grid>
        </Grid>
